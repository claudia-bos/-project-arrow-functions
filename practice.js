...
const evens = (array) => 
  array.filter((numbers) => numbers % 2 === 0 ? true : false) 
...
let orderTotals = orders.map((order) => order = order.price * (1 + order.tax))
...
const sortMenuItems = (obj) => {
  return exampleMenuItems.sort((a, b) => {
